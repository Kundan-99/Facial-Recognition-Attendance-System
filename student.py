...
class Student:
    def __init__(self,root):
        ...
        course_combo["values"]=("Select Course","BTECH","MTECH","BCA","MBA")
        ...
        #Roll No
        roll_no_label=Label(class_Student_frame,text="Reg No:",font=("times new roman",12,"bold"),bg="white")
        roll_no_label.grid(row=1,column=2,padx=10,pady=5,sticky=W)
            
        roll_no_entry=ttk.Entry(class_Student_frame,textvariable=self.var_reg,width=15,font=("times new roman",12,"bold"))
