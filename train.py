...
class Train:
    def __init__(self,root):
        ...
        img_top=Image.open(r"E:\FACE @\college_images\facialrecognition.png")
        img_top=img_top.resize((1300,265),Image.LANCZOS)
        self.photoimg_top=ImageTk.PhotoImage(img_top)
        
        f_lbl=Label(self.root,image=self.photoimg_top)
        f_lbl.place(x=0,y=35,width=1300,height=265)
        ...
        img_bottom=Image.open(r"E:\FACE @\college_images\face.jpg")
