...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        b1_1 = Button(bg_img, text="Face Detection", cursor="hand2", command=self.face_data, font=(
        ...
        # Developer Button
        img10 = Image.open(r"E:\FACE @\college_images\devvv.jpg")
        img10 = img10.resize((220, 150), Image.LANCZOS)
        self.photoimg10 = ImageTk.PhotoImage(img10)

        b1 = Button(bg_img, image=self.photoimg10, cursor="hand2")
        b1.place(x=720, y=300, width=220, height=150)

        b1_1 = Button(bg_img, text="Developer", cursor="hand2", font=(
            "times new roman", 15, "bold"), bg="darkblue", fg="white")
        b1_1.place(x=720, y=450, width=220, height=30)

        # Exit Button
        img11 = Image.open(r"E:\FACE @\college_images\exit.jpg")
        img11 = img11.resize((220, 150), Image.LANCZOS)
        self.photoimg11 = ImageTk.PhotoImage(img11)

        b1 = Button(bg_img, image=self.photoimg11, cursor="hand2")
        b1.place(x=1020, y=300, width=220, height=150)

        b1_1 = Button(bg_img, text="Exit", cursor="hand2", font=(
            "times new roman", 15, "bold"), bg="darkblue", fg="white")
        b1_1.place(x=1020, y=450, width=220, height=30)
